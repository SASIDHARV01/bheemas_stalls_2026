...
const CheckoutPage = () => {
  ...
  // 👉 UPDATED: Simplified state to only Name, Phone, Email, and UTR
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const templateParams = {
        ...
        google_form_link: "https://forms.gle/cMHH1g1uzmWGBiRn7",
  ...
  return (
    <div className="min-h-screen py-10 px-4 max-w-6xl mx-auto">
      <div className="flex items-center gap-4 mb-10">
        <Link to="/stalls" className="bg-neutral-900 p-3 rounded-full hover:bg-neutral-800 transition-colors border border-neutral-800">
          <ArrowLeft size={24} className="text-white" />
        </Link>
        <h1 className="text-4xl font-black text-white uppercase">Checkout</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div className="space-y-6">
          <div className="bg-neutral-900 p-6 md:p-8 rounded-2xl border border-neutral-800">
            ...
            {/* 👉 UPDATED: Super clean, minimal form! */}
        ...
        <div className="space-y-6">
          <div className="bg-neutral-900 p-6 md:p-8 rounded-2xl border border-neutral-800 text-center flex flex-col items-center">
            ...
            <a 
              href={upiLink}
              className="md:hidden w-full bg-blue-600 hover:bg-blue-500 text-white font-bold py-4 rounded-xl mb-6 flex items-center justify-center gap-2 transition-transform active:scale-95 shadow-lg shadow-blue-500/20"
            >
              Open UPI App to Pay ₹{cartTotal}
            </a>
            
            <p className="text-xs text-gray-500 text-left w-full">
              Make sure to copy the 12-digit UTR number from your app after paying!
            </p>
          </div>
